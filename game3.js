...
function preload() {
  ...
  game.load.image('goodend', 'Assets/rendos.jpg');
  game.load.image('badend', 'Assets/rendis.png');
  ...
  game.load.image('vinto', 'Assets/vinto.png');
  ...
  game.load.image('dbprofeta3', 'Assets/dbprofeta.png');
  game.load.image('tornagrotta', 'Assets/rigiocax.png');
  ...
  game.load.image('continua', 'Assets/menu-10.png');
...
sfondofinale.scale.setTo(0.9);
  ...
  // PLAYERQUI
  player = game.add.sprite(0, 1200, 'player');
  ...
  continua = game.add.sprite(420, 225, 'continua');
  ...
  continua.scale.setTo(1);

  badend = game.add.sprite(0, 0, 'badend');
  badend.visible = false;
  badend.scale.setTo(1);
  badend.fixedToCamera = true;
  badend.inputEnabled = true;
  badend.events.onInputDown.add(skip2);

  badend2 = game.add.sprite(0, 0, 'perso');
  badend2.visible = false;
  badend2.scale.setTo(1);
  badend2.fixedToCamera = true;

  buonafine = game.add.sprite(0, 0, 'goodend');
  buonafine.visible = false;
  buonafine.scale.setTo(1);
  buonafine.fixedToCamera = true;
  buonafine.inputEnabled = true;
  buonafine.events.onInputDown.add(skip1);

  buonafine2 = game.add.sprite(0, 0, 'vinto');
  buonafine2.visible = false;
  buonafine2.scale.setTo(1);
  buonafine2.fixedToCamera = true;

  tornaalteatro = game.add.sprite(340, 295, 'tornaalteatro');
  tornaalteatro.inputEnabled = true;
  tornaalteatro.visible = false;
  tornaalteatro.fixedToCamera = true;
  tornaalteatro.scale.setTo(1);
  tornaalteatro.events.onInputDown.add(end);

  tornaalteatro2 = game.add.sprite(340, 510, 'tornaalteatro');
  tornaalteatro2.inputEnabled = true;
  tornaalteatro2.visible = false;
  tornaalteatro2.fixedToCamera = true;
  tornaalteatro2.scale.setTo(1);
  tornaalteatro2.events.onInputDown.add(end);

  tornaallagrotta = game.add.sprite(430, 600, 'tornagrotta');
  tornaallagrotta.inputEnabled = true;
  tornaallagrotta.visible = false;
  tornaallagrotta.fixedToCamera = true;
  tornaallagrotta.events.onInputDown.add(tornagrotta);
...
saltandosx = false;
  ...
  if (tornaallagrotta.input.pointerOver()) {
    tornaallagrotta.tint = 0x73113D
  } else {
    tornaallagrotta.tint = 0xFFFFFF;
  }
  ...
  if (continua.input.pointerOver()) {
    continua.tint = 0x73113D
  } else {
    continua.tint = 0xFFFFFF;
  }

  if (tornaalteatro.input.pointerOver()) {
    tornaalteatro.tint = 0x73113D
  } else {
    tornaalteatro.tint = 0xFFFFFF;
  }

  if (tornaalteatro2.input.pointerOver()) {
    tornaalteatro2.tint = 0x73113D
  } else {
    tornaalteatro2.tint = 0xFFFFFF;
  }
}
...
function skip1() {
  buonafine2.visible = true;;
  tornaalteatro2.visible = true;
  tornaallagrotta.visible = true;
}
